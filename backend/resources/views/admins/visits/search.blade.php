...
@section('description', '来店履歴検索後のページ')
@section('title', '来店履歴検索')
@section('pageCss')
                            ...
                            <table id="datatablesSimple" class="link">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="box-m"><span class="login-button">メモ</span></th>
                                    </tr>
                                </thead>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><span class="login-button">顧客名</span></th>
                                        <th><span class="login-button">担当者</span></th>
                                        <th class="box-m" style="max-width: 90px;"><span class="login-button">メモ</span></th>
                                    </tr>
                                </tfoot>
                                <tbody>
                                    @foreach ($search as $visit)
                                        <tr>
                                            <td><a class="link"
