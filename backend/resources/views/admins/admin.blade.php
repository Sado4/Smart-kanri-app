            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card-body">
                        ...
                        <div>
                            <div>
                                <a href="{{ route('customer.create') }}"><button type="button" class="btn btn-primary btn-lg mb-3" data-toggle="modal"
                            ...
                            <form class="d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                                <div class="form-group">
                                    ...
                                    <div class="mb-3 form_deco">
                                        <input class="form-control" type="search" name="id" id="id" placeholder="検索"
                                            aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    </div>
