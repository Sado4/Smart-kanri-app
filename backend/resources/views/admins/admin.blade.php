            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card-body">
                        ...
                        <div>
                            <div>
                                <button type="button" class="btn btn-primary btn-lg mb-3" data-toggle="modal" data-target="#sampleModal">
                                    + 顧客情報新規作成
                                </button>
                                <p class="border-bottom"></p>
                            </div>
                            ...
                            <form class="d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                                <div class="form-group">
                                    ...
                                    <div class="mb-3 form_deco">
                                        <input class="form-control" type="search" name="name" id="name" placeholder="検索" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    </div>
                                        
                                    <label for="id">ID</label>
                                    <div class="mb-3 form_deco">
                                        <input class="form-control" type="search" name="id" id="id" placeholder="検索" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    </div>

                                    <label for="memo">メモ</label>
                                    <div class="mb-3 form_deco">
                                        <input class="form-control" type="search" name="memo" id="memo" placeholder="検索" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    </div>
                                        
                                    <label for="tel">電話番号</label>
                                    <div class="mb-4 form_deco">
                                        <input class="form-control" type="search" name="tel" id="tel" placeholder="完全一致検索" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    </div>
                                        
                                </div>

                                <div class="mb-4 text-right">
                                    <input type="submit" value="検索する" class="btn btn-primary btn-lg">
                                </div>
                            </form>
